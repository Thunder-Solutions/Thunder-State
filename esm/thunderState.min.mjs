...
const createStore = ({ actions: _actions = {}, computed: _computed = {}, ...config }) => {
    // clone so the user can't modify the state from the object reference they fed in
    const { state: protectedState = {}, name, enableDevTools = true, } = deepClone(config);
...
};export{createStore};//# sourceMappingURL=thunderState.min.mjs.map
