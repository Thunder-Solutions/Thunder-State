...
describe('State', () => {
  ...
  it('updates the state when actions are dispatched', () => {
    ...
    appState.dispatch('switchAccount', 'fake_three@gmail.com')
  ...
  it('travels back and forth through the action history', () => {
    appState = new State({
      debugVariable: 'state',
      ...testStateConfig,
    })
